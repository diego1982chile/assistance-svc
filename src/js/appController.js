  ...
  function(ko, Context, moduleUtils, KnockoutTemplateUtils, CoreRouter, ModuleRouterAdapter, KnockoutRouterAdapter, UrlParamAdapter, ResponsiveUtils, ResponsiveKnockoutUtils, ArrayDataProvider, OffcanvasUtils) {
     ...
     function ControllerViewModel() {
      ...
      let navData = [
        ...
        { path: 'assistances', id: 'assistances', detail: { label: 'Assistances', iconClass: 'oj-ux-ico-bar-chart' } },
        { path: 'schedules', id: 'schedules', detail: { label: 'Schedules', iconClass: 'oj-ux-ico-fire' } },                     
        { path: 'teachers', id: 'teachers', detail: { label: 'Teachers', iconClass: 'oj-ux-ico-fire' } },
        { path: 'subjects', id: 'subjects', detail: { label: 'Subjects', iconClass: 'oj-ux-ico-fire' } }        
      ];
    ...
    this.assistanceServiceBaseUrl = ko.observable("http://localhost:9191/api/");

    this.tokenServiceBaseUrl = ko.observable("http://localhost:9090/api/");
    ...
    this.authorize = (token) => { 
        ...
        this.router.go({path: 'assistances'});
